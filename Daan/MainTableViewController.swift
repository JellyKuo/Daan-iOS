...
class MainTableViewController: UITableViewController, tokenDelegate {
    
    func tokenChanged(token: Token?) {
        self.token = token
        print("MainTableViewController got token update")
    }
    ...
    // Using static tableview, config is not needed
    /*
